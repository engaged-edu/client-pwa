...
export function useValidations() {
	...
	return {
		...
		cpf: (message = i18n.t('validations.cpf')) => helpers.withMessage(message, (value) => CPF.validate(value)),
		cnpj: (message = i18n.t('validations.cnpj')) => helpers.withMessage(message, (value) => CNPJ.validate(value)),
