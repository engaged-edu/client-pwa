...
.layout.my-0.mx-auto.w-full.overflow-hidden.flex.flex-column
	...
	.surface-0.p-3.text-color-secondary.line-height-3(class="lg:p-6")
		.layout__container
			h1.font-bold.text-center.text-xl.text-green-500.my-0(class="lg:text-4xl") Isabella, parabéns sua compra foi aprovada!
	...
	.surface-0.p-3.text-gray-600.line-height-3(class="lg:p-6")
		.layout__container
			h1.font-bold.text-center.text-xl.my-0(class="lg:text-4xl") Isabella, parabéns sua compra foi aprovada!
