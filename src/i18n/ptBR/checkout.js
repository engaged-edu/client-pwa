	...
	welcome: {
		...
		steps: {
			...
			step1: {
				...
				description: 'Clique no botão abaixo <br> “{0}”'
			},
			step2: {
				title: 'Área de membros',
				description: 'Você será direcionado para a nossa área de membros'
			},
			step3: {
				title: 'Vitrine',
				description: 'Navegue até a seção “Vitrine” para acessar todo o conteúdo adquirido'
			}
		}
	}
};
