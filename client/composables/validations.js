...
export function useValidations() {
	...
	return {
		...
		phone: (message = i18n.t('validations.phone')) => helpers.withMessage(message, (value) => {
			const ayt = new AsYouType(value.phoneNumberCountry);

			ayt.input(value.phoneNumber);

			return ayt.isPossible();
		}),
